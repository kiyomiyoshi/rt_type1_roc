...
df <- subset(df, df$Condition == "1") # Full attention, expect target absent
df %>%
  group_by(Subj_idx) %>%
  summarise(n = n()) %>%
  print(n = 99999)
...
ggplot(df_wide) + 
  ...
  ggtitle("Sherman_2016_JOCN_1") + 
  theme_minimal() +
  theme(plot.title = element_text(size = 8),
        axis.title.x = element_blank(),
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> sigma_Sherman_2016_JOCN_1
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> mu_Sherman_2016_JOCN_1
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> da_Sherman_2016_JOCN_1
