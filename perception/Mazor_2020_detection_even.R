...
ggplot(df_wide_even) + 
  ...
  ) + ggtitle("Mazor_2020_Detection") + theme(plot.title = element_text(size = 10)) -> sigma_Mazor_2020_Detection_even
...
ggplot(df_wide_even) + 
  ...
  annotation_custom(
    ...
    xmin = -Inf, xmax = Inf, ymin = Inf, ymax = Inf
  ) + ggtitle("Mazor_2020_Detection") + theme(plot.title = element_text(size = 10)) -> mu_Mazor_2020_Detection_even
...
ggplot(df_wide_even) + 
  ...
  annotation_custom(
    ...
    xmin = -Inf, xmax = Inf, ymin = Inf, ymax = Inf
  ) + ggtitle("Mazor_2020_Detection") + theme(plot.title = element_text(size = 10)) -> da_Mazor_2020_Detection_even