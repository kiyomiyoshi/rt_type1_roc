...
ggplot(df_wide_odd) + 
  ...
  ) + ggtitle("Weidemann_2016") + theme(plot.title = element_text(size = 10)) -> sigma_Weidemann_2016_odd
...
ggplot(df_wide_odd) + 
  ...
  annotation_custom(
    ...
    xmin = -Inf, xmax = Inf, ymin = Inf, ymax = Inf
  ) + ggtitle("Weidemann_2016") + theme(plot.title = element_text(size = 10)) -> mu_Weidemann_2016_odd
...
ggplot(df_wide_odd) + 
  ...
  annotation_custom(
    ...
    xmin = -Inf, xmax = Inf, ymin = Inf, ymax = Inf
  ) + ggtitle("Weidemann_2016") + theme(plot.title = element_text(size = 10)) -> da_Weidemann_2016_odd