...
df <- fread("data_Siedlecka_2019_Exp2.csv", header = T)
df <- subset(df, df$Condition == "0")
df <- subset(df, df$Block_type >= 1 & df$Block_type <= 6)
...
for (i in unique(df$Subj_idx)) {
  ...
  nr_s1 <- c(sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 4, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 3, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 2, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 1, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "2" & d$Confidence == 1, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "2" & d$Confidence == 2, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "2" & d$Confidence == 3, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "2" & d$Confidence == 4, na.rm = TRUE))
  
  nr_s2 <- c(sum(d$Stimulus == "1" & d$Response == "1" & d$Confidence == 4, na.rm = TRUE),
             ...
             sum(d$Stimulus == "1" & d$Response == "2" & d$Confidence == 1, na.rm = TRUE),
             sum(d$Stimulus == "1" & d$Response == "2" & d$Confidence == 2, na.rm = TRUE),
             sum(d$Stimulus == "1" & d$Response == "2" & d$Confidence == 3, na.rm = TRUE),
             sum(d$Stimulus == "1" & d$Response == "2" & d$Confidence == 4, na.rm = TRUE))
...
ggplot(df_wide) + 
  ...
  ggtitle("Siedlecka_2019_Exp2_0") + 
  theme_minimal() +
  theme(plot.title = element_text(size = 8),
        axis.title.x = element_blank(),
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> sigma_Siedlecka_2019_Exp2_0
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> mu_Siedlecka_2019_Exp2_0
