...
df <- fread("data_Sadeghi_2017_memory.csv", header = T)
df <- subset(df, df$group == "patient")
length(unique(df$Subj_idx)) # 25
df %>%
  group_by(Subj_idx) %>%
  summarise(n = n()) %>%
  print(n = 99999) # 200
...
for (i in unique(df$Subj_idx)) {
  ...
  nr_s1 <- c(sum(d$Stimulus == "1" & d$Response == "0" & d$Confidence == 6, na.rm = TRUE),
             ...
             sum(d$Stimulus == "1" & d$Response == "1" & d$Confidence == 6, na.rm = TRUE))
  
  nr_s2 <- c(sum(d$Stimulus == "0" & d$Response == "0" & d$Confidence == 6, na.rm = TRUE),
             ...
             sum(d$Stimulus == "0" & d$Response == "1" & d$Confidence == 6, na.rm = TRUE))
...
for (i in unique(df$Subj_idx)) {
  ...
  nr_s1 <- c(sum(d$Stimulus == "1" & d$Response == "0" & d$RT_bin == 1, na.rm = TRUE),
             ...
             sum(d$Stimulus == "1" & d$Response == "1" & d$RT_bin == 1, na.rm = TRUE))
  
  nr_s2 <- c(sum(d$Stimulus == "0" & d$Response == "0" & d$RT_bin == 1, na.rm = TRUE),
             ...
             sum(d$Stimulus == "0" & d$Response == "1" & d$RT_bin == 1, na.rm = TRUE))
...
ggplot(df_wide) + 
  ...
  ggtitle("Sadeghi_2017_patient") + 
  theme_minimal() +
  theme(plot.title = element_text(size = 8),
        axis.title.x = element_blank(),
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> sigma_Sadeghi_2017_patient
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> mu_Sadeghi_2017_patient
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> da_Sadeghi_2017_patient