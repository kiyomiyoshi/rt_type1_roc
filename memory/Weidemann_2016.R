...
uvsdt_conf[, !(names(uvsdt_conf) %in% "id")] <- 
  lapply(uvsdt_conf[, !(names(uvsdt_conf) %in% "id")], as.numeric)

uvsdt_rt[, !(names(uvsdt_rt) %in% "id")] <- 
  lapply(uvsdt_rt[, !(names(uvsdt_rt) %in% "id")], as.numeric)
...
ggplot(df_wide) + 
  ...
  ggtitle("Weidemann_2016") + 
  theme_minimal() +
  theme(plot.title = element_text(size = 8),
        axis.title.x = element_blank(),
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> sigma_Weidemann_2016
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> mu_Weidemann_2016
...
ggplot(df_wide) + 
  ...
  theme(plot.title = element_text(size = 8),
        ...
        axis.title.y = element_blank(),
        axis.text.x  = element_text(size = 6),
        axis.text.y  = element_text(size = 6)) -> da_Weidemann_2016